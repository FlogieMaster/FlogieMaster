    ...
    for (let element in websites) {
        ...
        if (searchinput.value.includes('.')) {
            if (searchinput.value.includes('www') || searchinput.value.includes('https://')) {
                searchinput.value.includes('www') ? openLink("https://" + searchinput.value) : openLink(searchinput.value);
            } else {
                openLink("https://" + searchinput.value)
            }
        } else {
            openLink("https://google.com/search?q=" + searchinput.value);
        }
        searchinput.value = '';
        searchinput.select();
}
...
function openLink(link) {
    (dictionarySettings["target"] == "new") ? open(link) : url(link);
}
